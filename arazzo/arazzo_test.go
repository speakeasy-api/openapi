...
`)
	...
	expectedErrors := []struct {
		...
		{line: 1, column: 1, underlyingError: fmt.Errorf("arazzo.workflows is required")},
		{line: 1, column: 9, underlyingError: fmt.Errorf("arazzo.version only Arazzo versions between 1.0.0 and 1.0.1 are supported")},
		{line: 4, column: 3, underlyingError: fmt.Errorf("info.version is required")},
		{line: 6, column: 5, underlyingError: fmt.Errorf("sourceDescription.url is required")},
		{line: 7, column: 11, underlyingError: fmt.Errorf("sourceDescription.type must be one of [openapi, arazzo]")},
	}
