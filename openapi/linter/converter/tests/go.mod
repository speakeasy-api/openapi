...
require (
	github.com/speakeasy-api/openapi v1.16.1-0.20260209224317-dbec29eea3e0
	github.com/speakeasy-api/openapi/openapi/linter/customrules v0.0.0-20260209224317-dbec29eea3e0
