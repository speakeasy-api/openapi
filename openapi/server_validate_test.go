...
`,
			wantErrs: []string{"[2:6] url is required"},
		},
		{
...
variables:
  environment:
    description: Environment name
`,
			wantErrs: []string{"[5:5] field default is missing"},
		},
		{
...
variables:
  environment:
    ...
    description: Environment name
`,
			wantErrs: []string{"[5:14] default is required"},
		},
		{
...
variables:
  environment:
    ...
    description: Environment name
`,
			wantErrs: []string{"[7:7] default must be one of [staging, development]"},
		},
		{
...
`,
			wantErrs: []string{"[2:1] field default is missing"},
		},
		{
			name: "empty default",
			yml: `
...
`,
			wantErrs: []string{"[2:10] default is required"},
		},
		{
...
`,
			wantErrs: []string{"[4:3] default must be one of [valid1, valid2]"},
		},
	}
