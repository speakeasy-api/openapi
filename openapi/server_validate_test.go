...
`,
			wantErrs: []string{"[2:1] server field url is missing"},
		},
		{
			name: "empty URL",
			yml: `
...
`,
			wantErrs: []string{"[2:6] server field url is required"},
		},
		{
...
variables:
  environment:
    description: Environment name
`,
			wantErrs: []string{"[5:5] serverVariable field default is missing"},
		},
		{
...
variables:
  environment:
    ...
    description: Environment name
`,
			wantErrs: []string{"[5:14] serverVariable field default is required"},
		},
		{
...
variables:
  environment:
    ...
    description: Environment name
`,
			wantErrs: []string{"[7:7] serverVariable field default must be one of [staging, development]"},
		},
		{
...
`,
			wantErrs: []string{
				"[2:6] server field url is required",
				"[5:14] serverVariable field default is required",
			},
		},
	}
...
`,
			wantErrs: []string{"[2:1] serverVariable field default is missing"},
		},
		{
			name: "empty default",
			yml: `
...
`,
			wantErrs: []string{"[2:10] serverVariable field default is required"},
		},
		{
...
`,
			wantErrs: []string{"[4:3] serverVariable field default must be one of [valid1, valid2]"},
		},
	}
